...
public class MissingParameterException extends WebServiceException implements FormatConverter.Bean 
{
    ...
    {
        super("Missing parameter *".concat(param).concat("*"));
        _param = param;
    }
    
    public void convert(Builder builder, String format) 
    {
        super.convert(builder, format);
        builder.put("param", _param);
    }    
