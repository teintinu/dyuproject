...
package com.dyuproject.web.rest.mvc.controller;
...
import com.dyuproject.web.rest.mvc.Controller;
import com.dyuproject.web.rest.mvc.RESTControllerContext;
...
public class ContextController extends AbstractController
{
            ...
            HttpServletResponse response) throws IOException, ServletException
    {
        if(_defaultController==null)
            ...
            RESTControllerContext.handle(_defaultController, mime, request, response);
    }
