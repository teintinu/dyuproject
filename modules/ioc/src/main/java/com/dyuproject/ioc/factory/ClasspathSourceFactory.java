...
public class ClasspathSourceFactory extends AbstractSourceFactory
{
    
    private static final ClasspathSourceFactory __instance = new ClasspathSourceFactory();
    
    public static ClasspathSourceFactory getInstance()
    {
        return __instance;
    }
    ...
    public Source getSource(String resource) throws IOException
    {
        try
        {
            return getSource(Loader.getResource(ClasspathSourceFactory.class, resource, 
                    true).openStream());
        }
